...
class _WebServcie implements WebServcie {
  _WebServcie(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<ArticlesResponse> getNews(String category, String source) async {
    final _extra = <String, dynamic>{};
